...
//function to create indexes for each attribute in spell type table
pair<SpellTypeNameIndex, SpellTypeTypeIndex> createSpellTypeIndex(vector<SpellType> &tmpVec);

//function to create indexes for each attribute in player table
tuple<PlayerNameIndex, PlayerClassIndex, PlayerLvlIndex> createPlayerIndex(vector<Player> &tmpVec);

//function to create indexes for each attribute in spell class table
            ...
            switch (menuChoice)
            {
                  ...
                  case 2:
                  {
                        ...
                        if (choice1 == 1)
                        {
                              ...
                              projection(spellTypeList, choice3);
                        }
                        if (choice1 == 2)
                        {
                              cout << "\n\t1 - SpellName";
                              ...
                              projection(spellClassList, choice3);
                        }
                        if (choice1 == 3)
                        {
                              cout << "\n\t1 - Player Name";
